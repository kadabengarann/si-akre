...
@section('content')
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <p><b>Tabel : </b> 9.12. Kesesuaian Bidang Kerja Lulusan</p>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
            ...
            <a class="btn btn-success" href="/lkps/view/917">Next <i class="fas fa-arrow-circle-right"></i></a>
        </div> --}}
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/lkps/view/917">
                <div class="card-body">
        ...
        <div class="card-footer">
            ...
            <a href="/lkps/view/917" class="btn btn-default float-right">Cancel</a>
        </div>
        <!-- /.card-footer -->
        </form>
        </div>
