  ...
  <div class="card card-primary card-outline">
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-12 col-lg-6">
          ...
          <p><b>Tabel : </b>3.a.2) Dosen Pembimbing Utama Tugas Akhir
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Tabel 3.a.2) Dosen Pembimbing Utama Tugas Akhir
        </h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form class="form-horizontal" action="/lkps/view/312">
        <div class="card-body">
          ...
          <hr>
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-3 col-form-label">Rata-rata Jumlah Bimbingan di semua Program Semester</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="inputPassword3" placeholder="">
            </div>
          </div>
