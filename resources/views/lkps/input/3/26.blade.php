...
<section class="content">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <p><b>Tabel : </b>3.b.6) Produk/jasa DTPS yang diadopsi oleh industri/masyarakat 
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Tabel 3.b.6) Produk/jasa DTPS yang diadopsi oleh industri/masyarakat 
            </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal" action="/lkps/view/326">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Produk/Jasa</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label">Deskripsi Produk/Jasa</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                    </div>
                </div>
            ...
            <div class="card-footer">
                ...
                <a href="/lkps/view/326" class="btn btn-default float-right">Cancel</button>
            </div>
            <!-- /.card-footer -->
        </form>
    </div>
