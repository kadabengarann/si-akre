...
@section('content')
    <section class="content">
        <div class="card card-primary card-outline">
            ...
            <a class="btn btn-success" href="/lkps/view/616">Next <i class="fas fa-arrow-circle-right"></i></a>
        </div> --}}
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/lkps/view/616">
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/lkps/view/616" class="btn btn-default float-right">Cancel</button>
                    </div>
                    <!-- /.card-footer -->
            </form>
        </div>
