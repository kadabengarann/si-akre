    ...
    <section class="content">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Tabel 9.23 Prestasi Mahasiswa Program Kreatifitas Mahasiswa (PKM)
</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/lkps/view/811">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label">Penghargaan hibah kegiatan 
...
(PKM) dari</label>
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label">Tingkat 
lokal
</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputPassword3" placeholder="">
...
internasional</label>
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label">Dana tingkat 
lokal</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="inputPassword3" placeholder="">
                        </div>
