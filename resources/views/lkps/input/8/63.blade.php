    ...
    <section class="content">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Tabel 8.f.3) Produk/jasa yang dihasilkan mahasiswa yang diadopsi oleh
            ...
            <form class="form-horizontal" action="/lkps/view/863">
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="/lkps/view/863" class="btn btn-default float-right">Cancel</a>
                </div>
                <!-- /.card-footer -->
            </form>
        </div>
