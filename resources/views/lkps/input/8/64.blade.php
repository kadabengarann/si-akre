                ...
                <div class="tab-content" id="custom-tabs-two-tabContent">
                    <div class="tab-pane fade show active" id="custom-tabs-1" role="tabpanel"
                        ...
                        <div class="card-body pb-0 pt-0">
                            <h3 class="col-form-label text-center m-0 p-0">HKI (Paten, Paten Sederhana)</h3>
                            <hr>
                        </div>
                        <form class="form-horizontal" action="/lkps/view/864">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Luaran Penelitian dan PKM
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Keterrangan</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/lkps/view/864" class="btn btn-default float-right">Cancel</a>
                            </div>
                            <!-- /.card-footer -->
                        </form>
                    </div>
                    <div class="tab-pane fade" id="custom-tabs-2" role="tabpanel" aria-labelledby="custom-tabs-2-tab">
                        <div class="card-body pb-0 pt-0">
                            <h3 class="col-form-label text-center m-0 p-0">HKI (Hak Cipta, Desain Produk Industri, dll)</h3>
                            <hr>
                        </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-3" role="tabpanel" aria-labelledby="custom-tabs-3-tab">
                        <div class="card-body pb-0 pt-0">
                            <h3 class="col-form-label text-center m-0 p-0">Teknologi Tepat Guna, Produk, Karya Seni,
                                Rekayasa Sosial</h3>
                            <hr>
                        </div>
                        <form class="form-horizontal" action="/lkps/view/864">
                    ...
                    <div class="tab-pane fade" id="custom-tabs-4" role="tabpanel" aria-labelledby="custom-tabs-4-tab">
                        <div class="card-body pb-0 pt-0">
                            <h3 class="col-form-label text-center m-0 p-0">Buku Ber-ISBN,Book Chapter</h3>
                            <hr>
                        </div>
                        <form class="form-horizontal" action="/lkps/view/864">
                            <div class="card-body">
