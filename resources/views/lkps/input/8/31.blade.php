    ...
    <section class="content">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Tabel 8.c. Masa Studi Lulusan Program Studi</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            {{-- <div class="card-body pb-0">
                <h3 class="col-form-label text-center">Kerjasama Penelitian</h3>
                <hr>
            </div> --}}

            <form class="form-horizontal" action="/lkps/view/831">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="inputPassword3" class="col-sm-3 form-label">Jumlah Mahasiswa Yang :
                                Lulus Pada</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">akhir TS-5
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">akhir TS-4
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">akhir TS-2
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">akhir TS-1
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">akhir TS
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="">
                                    </div>
