...
@section('content')
    <section class="content">
        <div class="card card-primary card-outline">
            ...
            <a class="btn btn-success" href="/lkps/view/512">Next <i class="fas fa-arrow-circle-right"></i></a>
        </div> --}}
            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-two-tabContent">
                    <div class="tab-pane fade show active" id="custom-tabs-1" role="tabpanel"
                        ...
                        <form class="form-horizontal" action="/lkps/view/512">
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/lkps/view/512" class="btn btn-default float-right">Cancel</a>
                            </div>
                            <!-- /.card-footer -->
                        </form>
                    </div>
