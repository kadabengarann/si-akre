...
<section class="content">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <p><b>Tabel : </b>6.3. Matakuliah Pilihan (MBKM) yang harus ditempuh dan matakuliah pilihan yang disajikan
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">6.3. Matakuliah Pilihan (MBKM) yang harus ditempuh dan matakuliah pilihan yang disajikan
            </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
