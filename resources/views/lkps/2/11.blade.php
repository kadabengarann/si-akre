...
<section class="content">
  <div class="card card-primary card-outline">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 ml-4 mr-4">
      <a class="btn btn-info" href="/lkps/view/111"><i class="fas fa-arrow-circle-left"></i>  Prev</a>
      <a class="btn btn-success" href="/lkps/view/221">Next  <i class="fas fa-arrow-circle-right"></i></a>
    </div>
