  ...
  <div class="card card-primary card-outline">
    <div class="card-body">    
      <div class="row">
        ...
        <div class="col-12 col-lg-6">
          ...
          <p><b>Tabel : </b>Integrasi Kegiatan Penelitian/PkM dalam Pembelajaran</p>
        </div>
      </div>
    ...
    <div class="card card-primary card-outline">
      <div class="card-header">
        <h3 class="text-center card-title" style="float: none; font-weight:500">Integrasi Kegiatan Penelitian/PkM dalam Pembelajaran</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
