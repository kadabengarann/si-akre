            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <p><b>Tabel : </b>4.8. Peningkatan Kemampuan DTPS melalui program Tugas Belajar dalam bidang Infokom ( isian hanya untuk dosen 
yang sedang/belum selesai tugas belajar)
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="text-center card-title" style="float: none; font-weight:500">Peningkatan Kemampuan DTPS melalui program Tugas Belajar dalam bidang Infokom ( isian hanya untuk dosen 
