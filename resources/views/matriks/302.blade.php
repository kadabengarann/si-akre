                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai321" value="4">
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai321" value="3">
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai321" value="2">
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai321" value="1">
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai322" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai322" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai322" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai322" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai323" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai323" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai324" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai324" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai324" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai324" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai325" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai325" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai325" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai325" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai326" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai326" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai326" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai326" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai327" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai327" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai327" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai327" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai328" value="4">
                                    <span class="caption">4</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai329" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai329" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai329" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai329" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3210" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3210" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3210" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3210" value="1">
                                    <span class="caption">1</span></label>
                        ...
                        <tr>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3211" value="4">
                                    <span class="caption">4</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3211" value="3">
                                    <span class="caption">3</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3211" value="2">
                                    <span class="caption">2</span></label>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input type="radio" name="nilai3211" value="1">
                                    <span class="caption">1</span></label>
