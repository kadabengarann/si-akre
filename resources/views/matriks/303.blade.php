            ...
            <div class="card-body">
                <table id="tbl_list" class="table table-bordered table-center-text">
                    ...
                    <tbody>
                        <div class="nilai">
                            <tr class="nilai">
                                <th colspan="11" class="nilai">3.1 [PENETAPAN]</th>
                            </tr>
                        </div>
                        @php($row_id = 331)
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td class="text-start">3.1 [PENETAPAN] A. Ketersediaan dokumen kebijakan, standar, IKU, dan
                                IKT yang berkaitan dengan mahasiswa terkait sistem rekrutmen.
                            </td>{{-- ELEMEN --}}
                            <td></td>{{-- LOKASI --}}
                            <td>3.1 [PENETAPAN] Ketersediaan dokumen kebijakan, standar, IKU, dan IKT yang berkaitan dengan
                                mahasiswa mencakup: A. Sistem rekrutmen (metode rekrutmen, kriteria) dan proses seleksi
                                calon mahasiswa.
                            </td>{{-- DESKRIPTOR --}}
                            <td class="penilaian_check_field">
                                ...
                                <span class="tooltiptext">Tersedianya sistem rekrutmen (metode rekrutmen, kriteria) dan
                                    proses seleksi calon mahasiswa, disertai bukti yang sahih dan sangat lengkap.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                ...
                                <span class="tooltiptext">Tersedianya sistem rekrutmen (metode rekrutmen, kriteria) dan
                                    proses seleksi calon mahasiswa, disertai bukti yang sahih dan lengkap.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                ...
                                <span class="tooltiptext">Tersedianya sistem rekrutmen (metode rekrutmen, kriteria) dan
                                    proses seleksi calon mahasiswa, disertai bukti yang sahih dan cukup lengkap.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                ...
                                <span class="tooltiptext">Tersedianya sistem rekrutmen (metode rekrutmen, kriteria) dan
                                    proses seleksi calon mahasiswa, disertai bukti yang sahih dan kurang lengkap.</span>
                            </td>
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 4 ? 'checked' : '' }} type="radio"
                                        name="nilai{{ $row_id }}" value="4">
                                    <span class="caption">4</span></label>
                                <span class="tooltiptext">Tersedianya sistem layanan kepada mahasiswa, disertai bukti
                        ...
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td></td>{{-- LOKASI --}}
                            <td>C. Ketersediaan kebijakan peningkatan animo calon mahasiswa di level lokal, nasional atau
                                internasional.
                            </td>{{-- DESKRIPTOR --}}
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 4 ? 'checked' : '' }} type="radio"
                                        name="nilai{{ $row_id }}" value="4">
                                    <span class="caption">4</span></label>
                                <span class="tooltiptext">Tersedianya kebijakan peningkatan animo calon mahasiswa di
                                    level lokal, nasional atau internasional disertai bukti yang sahih dan sangat
                                    lengkap.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    ...
                                    <span class="caption">3</span></label>
                                <span class="tooltiptext">Tersedianya kebijakan peningkatan animo calon mahasiswa di
                                    level lokal, nasional atau internasional disertai bukti yang sahih dan lengkap.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 2 ? 'checked' : '' }} type="radio"
                                    ...
                                    <span class="caption">2</span></label>
                                <span class="tooltiptext">Tersedianya kebijakan peningkatan animo calon mahasiswa di
                                    level lokal, nasional atau internasional disertai bukti yang sahih dan cukup
                                    lengkap.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    ...
                                    <span class="caption">1</span></label>
                                <span class="tooltiptext">Tersedianya kebijakan peningkatan animo calon mahasiswa di
                                    level lokal, nasional atau internasional disertai bukti yang sahih dan kurang
                                    lengkap.</span>
                            </td>
                        ...
                        <div class="nilai">
                            <tr class="nilai">
                                <th colspan="11" class="nilai">3.2 [PELAKSANAAN]</th>
                            </tr>
                        </div>
                        @php($row_id = 334)
                        @php($lkps = 301)
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 4 ? 'checked' : '' }} type="radio"
                                        name="nilai{{ $row_id }}" value="4">
                                    <span class="caption">4</span></label>
                                <span class="tooltiptext">Terlaksananya sistem rekrutmen dan seleksi calon mahasiswa
                                    serta pertumbuhan jumlah mahasiswa secara sangat efektif, disertai bukti yang
                                    sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    ...
                                    <span class="caption">3</span></label>
                                <span class="tooltiptext">Terlaksananya sistem rekrutmen dan seleksi calon mahasiswa
                                    serta pertumbuhan jumlah mahasiswa secara efektif, disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 2 ? 'checked' : '' }} type="radio"
                                    ...
                                    <span class="caption">2</span></label>
                                <span class="tooltiptext">Terlaksananya sistem rekrutmen dan seleksi calon mahasiswa
                                    serta pertumbuhan jumlah mahasiswa secara cukup efektif, disertai bukti yang
                                    sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    ...
                                    <span class="caption">1</span></label>
                                <span class="tooltiptext">Terlaksananya sistem rekrutmen dan seleksi calon mahasiswa
                                    serta pertumbuhan jumlah mahasiswa secara kurang efektif, disertai bukti yang
                                    sahih.</span>
                            </td>
                        ...
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td class="text-start">B. Keterlaksanaan mutu, akses dan kecukupan layanan kepada
                                mahasiswa.
                            </td>{{-- ELEMEN --}}
                            <td></td>{{-- LOKASI --}}
                            ...
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 4 ? 'checked' : '' }} type="radio"
                                        name="nilai{{ $row_id }}" value="4">
                                    <span class="caption">4</span></label>
                                <span class="tooltiptext">Terlaksananya mutu, akses dan kecukupan layanan kepada
                                    mahasiswa yang sangat memadai, disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 3 ? 'checked' : '' }} type="radio"
                                    ...
                                    <span class="caption">3</span></label>
                                <span class="tooltiptext">Terlaksananya mutu, akses dan kecukupan layanan kepada
                                    mahasiswa yang memadai, disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 2 ? 'checked' : '' }} type="radio"
                                    ...
                                    <span class="caption">2</span></label>
                                <span class="tooltiptext">Terlaksananya mutu, akses dan kecukupan layanan kepada
                                    mahasiswa yang cukup memadai, disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 1 ? 'checked' : '' }} type="radio"
                                    ...
                                    <span class="caption">1</span></label>
                                <span class="tooltiptext">Terlaksananya mutu, akses dan kecukupan layanan kepada
                                    mahasiswa yang kurang memadai, disertai bukti yang sahih.</span>
                            </td>
                        ...
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td></td>{{-- LOKASI --}}
                            <td>C. Keterlaksanaan upaya peningkatan animo calon mahasiswa di level lokal, nasional atau
                                internasional.
                            </td>{{-- DESKRIPTOR --}}
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 4 ? 'checked' : '' }} type="radio"
                                        name="nilai{{ $row_id }}" value="4">
                                    <span class="caption">4</span></label>
                                <span class="tooltiptext">Terlaksananya upaya peningkatan animo calon mahasiswa di level
                                    lokal, nasional atau internasional dengan sangat efektif, disertai bukti yang
                                    sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    ...
                                    <span class="caption">3</span></label>
                                <span class="tooltiptext">Terlaksananya upaya peningkatan animo calon mahasiswa di level
                                    lokal, nasional atau internasional dengan efektif, disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 2 ? 'checked' : '' }} type="radio"
                                    ...
                                    <span class="caption">2</span></label>
                                <span class="tooltiptext">Terlaksananya upaya peningkatan animo calon mahasiswa di level
                                    lokal, nasional atau internasional dengan cukup efektif, disertai bukti yang
                                    sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    ...
                                    <span class="caption">1</span></label>
                                <span class="tooltiptext">Terlaksananya upaya peningkatan animo calon mahasiswa di level
                                    lokal, nasional atau internasional dengan kurang efektif, disertai bukti yang
                                    sahih.</span>
                            </td>
                        ...
                        <div class="nilai">
                            <tr class="nilai">
                                <th colspan="11" class="nilai">3.3 [EVALUASI]</th>
                            </tr>
                        </div>
                        @php($row_id = 337)
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td class="text-start">3.3 [EVALUASI] Keterlaksanaan evaluasi secara berkala mengenai
                                kebijakan dan ketercapaian standar (IKU dan IKT) terkait mahasiswa.
                            </td>{{-- ELEMEN --}}
                            <td></td>{{-- LOKASI --}}
                            <td>3.3 [EVALUASI] Keterlaksanaan evaluasi secara berkala mengenai kebijakan dan ketercapaian
                                standar (IKU dan IKT) sehingga menemu-kenali praktik baik, praktik buruk dan praktik yang
                                baru yang berkaitan dengan mahasiswa, termasuk evaluasi tingkat kepuasan mahasiswa terhadap
                                layanan mahasiswa.
                            </td>{{-- DESKRIPTOR --}}
                            <td class="penilaian_check_field">
                                <label>
                                ...
                                <span class="tooltiptext">Terlaksananya evaluasi secara berkala dan sangat efektif
                                    ...
                                    praktik baik, praktik buruk dan praktik yang baru yang berkaitan dengan mahasiswa,
                                    termasuk evaluasi tingkat kepuasan mahasiswa terhadap layanan mahasiswa.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 3 ? 'checked' : '' }} type="radio"
                                ...
                                <span class="tooltiptext">Terlaksananya evaluasi secara berkala dan efektif mengenai
                                    ...
                                    evaluasi tingkat kepuasan mahasiswa terhadap layanan mahasiswa.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 2 ? 'checked' : '' }} type="radio"
                        ...
                        <div class="nilai">
                            <tr class="nilai">
                                <th colspan="11" class="nilai">3.4 [PENGENDALIAN]</th>
                            </tr>
                        </div>
                        @php($row_id = 338)
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td class="text-start">3.4 [PENGENDALIAN] Ketersediaan dokumen tindak lanjut dan
                                implementasi terhadap hasil evaluasi ketercapaian standar (IKU dan IKT).
                            </td>{{-- ELEMEN --}}
                            <td></td>{{-- LOKASI --}}
                            <td>3.4 [PENGENDALIAN] Ketersediaan dokumen tindak lanjut dan implementasi (revisi dan
                            ...
                            <td class="penilaian_check_field">
                                ...
                                <span class="tooltiptext">Tersedianya dokumen tindak lanjut dan implementasi yang sangat
                                    ...
                                    IKT) yang berkaitan dengan mahasiswa.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 3 ? 'checked' : '' }} type="radio"
                        ...
                        <div class="nilai">
                            <tr class="nilai">
                                <th colspan="11" class="nilai">3.5 [PENINGKATAN]</th>
                            </tr>
                        </div>
                        @php($row_id = 339)
                        <tr class="{{ getArrayItem($row_id, $dataMatriks)->remainingField != 0 ? 'incomplete' : '' }} "
                            ...
                            <td class="text-start">3.5 [PENINGKATAN] Keterlaksanaan proses optimalisasi terhadap
                                standar (IKU dan IKT) terkait mahasiswa.
                            </td>{{-- ELEMEN --}}
                            <td></td>{{-- LOKASI --}}
                            <td>3.5 [PENINGKATAN] Keterlaksanaan proses optimalisasi (peningkatan, penyesuaian, dan
                            ...
                            <td class="penilaian_check_field">
                                ...
                                <span class="tooltiptext">Terlaksananya proses optimalisasi secara sangat efektif
                                    ...
                                    berkaitan dengan mahasiswa disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 3 ? 'checked' : '' }} type="radio"
                                ...
                                <span class="tooltiptext">Terlaksananya proses optimalisasi secara efektif (peningkatan,
                                    ...
                                    mahasiswa disertai bukti yang sahih.</span>
                            </td>
                            <td class="penilaian_check_field">
                                <label>
                                    <input {{ getMatriksGrade($row_id, $matriks) == 2 ? 'checked' : '' }} type="radio"
